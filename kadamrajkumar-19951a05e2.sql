...
/* 2)Write a SQL query to  list a customerid, customer name whose name starts with 'sa'? */
...
/* 3)Write a SQL query to  list the Customer IDs and names belonging to the gold customer segment? */
